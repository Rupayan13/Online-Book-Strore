...
$products = $con->query("SELECT COUNT(*) as product_num FROM products");
$products->execute();
$allProducts = $products->fetch(PDO::FETCH_OBJ);

$categories = $con->query("SELECT COUNT(*) as categories_num FROM categories");
$categories->execute();
$allCategories = $categories->fetch(PDO::FETCH_OBJ);

$admins = $con->query("SELECT COUNT(*) as admins_num FROM admins");
$admins->execute();
        ...
        <div class="col-md-4">
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text">number of products: <?php echo $allProducts->product_num; ?></p>
