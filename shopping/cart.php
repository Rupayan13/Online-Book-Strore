...
$products = $con->query("SELECT * FROM cart WHERE user_id='$_SESSION[user_id]'");
$products->execute();
                  ...
                  <table class="table" height="190" >
                    <thead>
                      <tr>
                        ...
                        <th scope="col"><a href="#" class="btn btn-warning text-white">Update</a></th>
                    ...
                    <tbody>
                      ...
                      <?php endforeach; ?>
                      <?php else: ?>
                        <div class="alert alert-danger bg-danger text-white">There is no Products in the cart</div>
                      <?php endif; ?>
                      </tbody>
                  </table>
